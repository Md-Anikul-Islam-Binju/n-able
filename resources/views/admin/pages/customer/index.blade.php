                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($company as $key=>$companyData)
                        <tr>
                            ...
                            <td>
                                <img src="{{asset('images/company/'. $companyData->image )}}" alt="Current Image" style="max-width: 50px;">
                            </td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="link" name="link" value="{{$companyData->link}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <img src="{{asset('images/company/'. $companyData->image )}}" alt="File or  Image" class="mt-2" style="max-width: 50px;">
                                                        </div>
                                                    </div>
